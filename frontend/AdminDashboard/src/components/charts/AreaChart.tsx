          ...
          <RechartsAreaChart data={data} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
            <defs>
              {areas.map((area, index) => (
                <linearGradient key={area.key} id={`gradient-${area.key}`} x1="0" y1="0" x2="0" y2="1">
                  <stop 
                    offset="5%" 
                    stopColor={area.color || theme.colors.chart[index % theme.colors.chart.length]} 
                    stopOpacity={0.8}
                  />
                  <stop 
                    offset="95%" 
            ...
            {areas.map((area, index) => (
              <Area
                ...
                stroke={area.color || theme.colors.chart[index % theme.colors.chart.length]}
